        ...
        Button.OnClickListener startListener = new Button.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if (v == dictationButton)
                    _currentRecognizer = MainView.getSpeechKit().createRecognizer(Recognizer.RecognizerType.Dictation, Recognizer.EndOfSpeechDetection.Long, language, _listener, _handler);
                else
                    _currentRecognizer = MainView.getSpeechKit().createRecognizer(Recognizer.RecognizerType.Search, Recognizer.EndOfSpeechDetection.Short, language, _listener, _handler);
